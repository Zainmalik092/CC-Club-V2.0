      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive ? "text-yellow-500 bg-yellow-500/5" : "text-neutral-400 hover:text-white"
                  )}
                >
                  <Icon size={16} />
                  {link.label}
        ...
        <div className="flex items-center gap-6">
          <div className="flex flex-col items-end">
            <span className="text-[10px] text-neutral-500 uppercase tracking-widest font-bold">Balance</span>
